...
object StormRunner {
  ...
  lazy val config = new ConfigurationBuilder()
    .setOAuthConsumerKey("XvRtoIddxvc2bIAVED8eCbENk")
    .setOAuthConsumerSecret("kHoiDKQrKbDKzGU7YVk7mocQZN2HPvuka4MvXTdneTPYlV0cAP")
    .setOAuthAccessToken("1148538656-KkRYO5tCITZTsJLTE3Hh0V5sO9CksI85AFLJW0K")
    .setOAuthAccessTokenSecret("TgkvpiuSxsTNhDfYORvpNUt0CaN2wPABNyNBMheXLmmuM")
